      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            <button onClick={() => onNavigate('contact')} className="bg-cyber-navy/50 text-slate-300 hover:text-white px-4 py-2 rounded-lg font-bold border border-cyber-powder/20 hover:border-cyber-sapphire/30 transition-all text-[11px]">
              اتصل بنا
            </button>
          </div>
        </div>
